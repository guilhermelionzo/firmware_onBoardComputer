...
#define AODCS_TASK_TICK_PERIOD 10/portTICK_RATE_MS       //=10/1ms => period 100ms
#define AODCS_TASK_TICK_PERIOD_LOW_BATTERY AODCS_TASK_TICK_PERIOD*5//2s

#define CAMERA_TASK_TICK_PERIOD 10/portTICK_RATE_MS       //100ms
#define CAMERA_TASK_TICK_PERIOD_LOW_BATTERY CAMERA_TASK_TICK_PERIOD*5//2s

#define DATA_STORAGE_TICK_PERIOD 10/portTICK_RATE_MS       //100ms
#define DATA_STORAGE_TICK_PERIOD_LOW_BATTERY DATA_STORAGE_TICK_PERIOD*5//2s

#define HOUSE_KEEPING_TICK_PERIOD 10/portTICK_RATE_MS       //100ms( pdMS_TO_TICKS( 300UL ) )//
#define HOUSE_KEEPING_TICK_PERIOD_LOW_BATTERY HOUSE_KEEPING_TICK_PERIOD*5//2s

#define PPT_TASK_TICK_PERIOD 10/portTICK_RATE_MS      //100ms
#define PPT_TASK_TICK_PERIOD_LOW_BATTERY PPT_TASK_TICK_PERIOD*5//2s

#define TTC_TASK_TICK_PERIOD 1/portTICK_RATE_MS       //100ms( pdMS_TO_TICKS( 300UL ) )
#define TTC_TASK_TICK_PERIOD_LOW_BATTERY TTC_TASK_TICK_PERIOD*5//2s

#define TASK_MANAGER_TICK_PERIOD 1/portTICK_RATE_MS      //100ms( pdMS_TO_TICKS( 300UL ) )
#define TASK_MANAGER_TICK_PERIOD_LOW_BATTERY TTC_TASK_TICK_PERIOD*5//2s

#define WATCHDOG_TASK_TICK_PERIOD 3/portTICK_RATE_MS       //100ms
#define WATCHDOG_TASK_TICK_PERIOD_LOW_BATTERY WATCHDOG_TASK_TICK_PERIOD*5//2s

//DEBUG SESSION
#define DEBUG_SESSION 1
#define DEGUB_SESSION_TRACEALYZER 1

#if DEGUB_SESSION_TRACEALYZER
traceString stateChanel;
#endif
...
volatile static dataPacket obcData;
volatile static DataFlash dataFlash;

volatile int flag_lowBattery;
volatile int flag_systemMode;

static volatile int deleted = 0;
