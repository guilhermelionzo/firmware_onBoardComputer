...
#define AODCS_TASK_TICK_PERIOD 1000/portTICK_RATE_MS/2       //=1000/1ms => period 1000ms
#define AODCS_TASK_TICK_PERIOD_LOW_BATTERY AODCS_TASK_TICK_PERIOD*4//2s

#define CAMERA_TASK_TICK_PERIOD 1000/portTICK_RATE_MS/2       //1000ms
#define CAMERA_TASK_TICK_PERIOD_LOW_BATTERY CAMERA_TASK_TICK_PERIOD*4//2s

#define DATA_STORAGE_TICK_PERIOD 1000/portTICK_RATE_MS/2       //1000ms
#define DATA_STORAGE_TICK_PERIOD_LOW_BATTERY DATA_STORAGE_TICK_PERIOD*4//2s

#define HOUSE_KEEPING_TICK_PERIOD 1000/portTICK_RATE_MS/2       //1000ms( pdMS_TO_TICKS( 300UL ) )//
#define HOUSE_KEEPING_TICK_PERIOD_LOW_BATTERY HOUSE_KEEPING_TICK_PERIOD*4//2s

#define PPT_TASK_TICK_PERIOD 1000/portTICK_RATE_MS/2       //1000ms
#define PPT_TASK_TICK_PERIOD_LOW_BATTERY PPT_TASK_TICK_PERIOD*4//2s

#define TTC_TASK_TICK_PERIOD 1000/portTICK_RATE_MS/2       //1000ms( pdMS_TO_TICKS( 300UL ) )
#define TTC_TASK_TICK_PERIOD_LOW_BATTERY TTC_TASK_TICK_PERIOD*4//2s

#define TASK_MANAGER_TICK_PERIOD 1000/portTICK_RATE_MS/2       //1000ms( pdMS_TO_TICKS( 300UL ) )
#define TASK_MANAGER_TICK_PERIOD_LOW_BATTERY TTC_TASK_TICK_PERIOD*4//2s

#define WATCHDOG_TASK_TICK_PERIOD 1000/portTICK_RATE_MS/2       //1000ms
#define WATCHDOG_TASK_TICK_PERIOD_LOW_BATTERY WATCHDOG_TASK_TICK_PERIOD*4//2s
